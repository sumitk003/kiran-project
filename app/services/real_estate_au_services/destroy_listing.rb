  ...
  class DestroyListing
    ...
    def destroy_listing
      ...
      if response.code.between?(200, 299)
        Rails.logger.info("[RealEstateAuServices::DestroyListing] SUCCESS Destroyed listing. Got HTTP response #{response.code}")
    ...
    def handle_error(response)
      ...
      Rails.logger.error("[RealEstateAuServices::DestroyListing] ERROR deleting listing. Got HTTP response #{response_code}")
